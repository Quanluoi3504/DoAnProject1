                ...
                <div class="row">
                    ...
                    <div id="footer" align="center" class="col">THÔNG TIN
                        <div id="top_line_footer">
                            <p><a href="page_homepage.php"><i class="fa-solid fa-house"></i> Trang chủ </a></p>
                            <p><a href="page_introduce.php"><i class="fa-solid fa-share-nodes"></i> Giới thiệu</a></p>
                            <p><a href="page_product.php"><i class="fa-solid fa-book"></i> Sản phẩm </a></p>
                            <p><a href="page_news.php"><i class="fa-solid fa-newspaper"></i> Tin tức </a></p>
                            <p><a href="page_contact.php"><i class="fa-solid fa-phone"></i> Liên hệ</a></p>
                        </div>
                    </div>
                    <div id="footer" align="center" class="col">THÔNG TIN
                        <div id="top_line_footer" >

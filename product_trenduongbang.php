    ...
    <!--<top>-->
        <div id="product" style="font-family: 'Helvetica Neue'">
            <div class="container">
                <div class="col">
                    <div class="row">
                        <div id="trangchu"> <a href="page_homepage.php">Trang chủ</a><i class="fa-solid fa-arrow-right"></i><a href="page_homepage.php"> Sách kỹ năng </a><i class="fa-solid fa-arrow-right"></i><span style="color: orange"> Trên đường băng</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!--<product>-->
        <div class="container" style="font-family: 'Helvetica Neue'">
                    <div id="img-diquahoacuc">
                        <img src="image/tren-duong-bang--1-.png" style="width: 200px" alt="">
                        <img src="image/tren-duong-bang--2-.png" style="width: 200px" alt="">
                    </div>
                    <div id="diquahoacuc">
                        <div id="diquahoacuc-name">Trên đường băng</div>
